...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.char-btn').forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.stopPropagation();
      const cardName = this.closest('.char-card').querySelector('.char-name').textContent;
      window.location.href = 'aluguel/novo.jsp?personagem=' + encodeURIComponent(cardName);
    });
  });

  /* ---- CTA primary button ---- */
  document.querySelectorAll('[data-action="reservar"]').forEach(function (btn) {
    btn.addEventListener('click', function () {
